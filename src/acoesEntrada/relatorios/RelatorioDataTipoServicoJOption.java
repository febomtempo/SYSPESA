 ...
 * @author Notebook
 */
public class RelatorioDataTipoServicoJOption implements Acao{

    //Relatórios por Data (Ano e Mês) e Despesa de Serviço que que recebe os valores da data digitados pelo usuário 
    //e verifica o valor do tipo de despesa do enum pelo MenuToString.
    ...
    public void acao(List<Despesa> despesas, List<Fornecedor> fornecedores) {
        ...
        JOptionPane.showMessageDialog(null, ListarDespesasDataTipo.listaDespesasServico(despesas, ano, mes));
    }
}
