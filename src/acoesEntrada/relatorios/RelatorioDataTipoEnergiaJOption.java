 ...
 * @author Notebook
 */
public class RelatorioDataTipoEnergiaJOption implements Acao{

    //Relatórios por Data (Ano e Mês) e Despesa de Energia que que recebe os valores da data digitados pelo usuário 
    //e verifica o valor do tipo de energia do enum pelo MenuToString.
    ...
    public void acao(List<Despesa> despesas, List<Fornecedor> fornecedores) {
        ...
        JOptionPane.showMessageDialog(null, ListarDespesasDataTipo.listaDespesasEnergia(despesas, ano, mes));
    }
