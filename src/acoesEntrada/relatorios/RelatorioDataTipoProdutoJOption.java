 ...
 * @author Notebook
 */
public class RelatorioDataTipoProdutoJOption implements Acao{
    
    //Relatórios por Data (Ano e Mês) e Despesa de Produto que que recebe os valores da data digitados pelo usuário 
    //e verifica o valor do tipo de produto do enum pelo MenuToString.
    ...
    public void acao(List<Despesa> despesas, List<Fornecedor> fornecedores) {
        ...
        JOptionPane.showMessageDialog(null, ListarDespesasDataTipo.listaDespesasProduto(despesas, ano, mes));
    }
}
