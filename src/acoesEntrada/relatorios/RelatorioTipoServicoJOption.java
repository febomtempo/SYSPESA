 ...
 * @author Notebook
 */
public class RelatorioTipoServicoJOption implements Acao{

    //Exibe o relatório de despesas de serviço.
    
    @Override
    public void acao(List<Despesa> despesas, List<Fornecedor> fornecedores) {
        JOptionPane.showMessageDialog(null, ListarDespesasTipo.listaDespesasServico(despesas));
    }
}
